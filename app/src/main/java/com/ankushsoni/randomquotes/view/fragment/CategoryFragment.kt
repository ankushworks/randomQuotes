...
import com.ankushsoni.randomquotes.viewmodelfactory.CategoryViewModelFactory
...
//
//
//        categoryViewModel = ViewModelProvider(this , CategoryViewModelFactory(repository)).get(CategoryViewModel::class.java)
//
//        categoryViewModel.quoteCategoryData.observe(viewLifecycleOwner){
